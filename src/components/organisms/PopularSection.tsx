...
const PopularSection: React.FC = () => {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 justify-center items-center text-center">
        {(
          activePopular === "MERK" ? merkFeatures : kategoriFeatures
        ).map((feature, index) => (
