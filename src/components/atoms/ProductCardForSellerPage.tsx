...
const ProductCard = ({ product }: { product: ProductProps }) => {
  ...
  return (
    ...
    >
      ...
      <img src={image.startsWith("data:image/") ? image : `../${image}`} alt={name} onError={(e) => (e.currentTarget.src = "../assets/img/produk/dummy.jpg")} className="w-full h-52 object-cover rounded-t-lg" />
